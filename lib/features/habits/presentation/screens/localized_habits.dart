  ...
  static List<DefaultHabit> getBadHabits(BuildContext context) {
    return [
      ...
      DefaultHabit(
        ...
        unitLabel: 'hour',
        isGoodHabit: false,
        motivation: 'Reducing social media improves focus and mental health',
      ),
      DefaultHabit(
        id: 'alcohol',
        ...
        unitLabel: 'ml',
        isGoodHabit: false,
        motivation: 'Avoiding alcohol improves sleep and overall health',
      ),
      DefaultHabit(
        id: 'procrastinate',
        ...
        unitLabel: 'times',
        isGoodHabit: false,
        motivation: 'Overcoming procrastination boosts productivity and reduces stress',
      ),
    ];
  }
}
